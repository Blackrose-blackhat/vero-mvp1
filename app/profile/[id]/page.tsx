...
import { getUserProfile } from '@/app/repo_actions';
...
export default async function PublicProfilePage({ params }: PageProps) {
    ...
    const { user: profileUser, posts: userPosts, error } = await getUserProfile(id);
                            ...
                            <div className="flex flex-col items-center text-center gap-6">
                                ...
                                <div className="w-full space-y-4 text-left">
                                    ...
                                    <div className="flex items-center gap-3 text-[11px] font-bold text-muted-foreground/80 lowercase tracking-tight">
                                        ...
                                        github.com/{profileUser.email.split('@')[0]}
                                    </div>
                                    <div className="flex items-center gap-3 text-[11px] font-bold text-muted-foreground/80 lowercase tracking-tight">
